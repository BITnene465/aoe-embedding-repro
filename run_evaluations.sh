...
# 1. NLI Models -> Standard STS Transfer (2 runs)
# 2. NLI Models -> Downstream Transfer (2 runs)
# 3. STS-B Models -> STS-B In-domain (2 runs)
# 4. GIS Models -> GIS In-domain (2 runs)
...
echo -e "${BOLD}${BLUE}========================================================${NC}"
echo -e "${BOLD}${BLUE}Starting Batch Evaluations${NC}"
echo -e "${BOLD}${BLUE}========================================================${NC}"
